...
const enTranslations = {
  ...
  history: {
    ...
    stops: 'stops',
    subtitle: 'Your recently planned routes',
    departure: 'Departure',
    destination: 'Destination',
    replan: 'Replan',
    clickOutside: 'Click anywhere outside to exit',
    roundTrip: 'Round Trip',
...
const roTranslations = {
  ...
  history: {
    viewHistory: 'Vezi Istoric Căutări',
    recentRoutes: 'rute recente',
    recentSearches: 'Căutări Recente',
    stops: 'opriri',
    subtitle: 'Ultimele rute planificate de tine',
    departure: 'Plecare',
    destination: 'Destinație',
    replan: 'Replanifică',
    clickOutside: 'Apasă oriunde afară pentru a ieși',
    roundTrip: 'Dus-întors',
    directRoute: 'Traseu direct',
  },
  time: {
    justNow: 'Chiar acum',
    minutesAgo: 'Acum {{count}} minute',
    oneHourAgo: 'Acum 1 oră',
