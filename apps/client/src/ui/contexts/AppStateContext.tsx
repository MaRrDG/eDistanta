...
import type { RouteData, Waypoint } from '@core/entities/location';
import type { RouteWeather } from '@core/entities/weather';
...
interface AppStateContextType {
  ...
  tollModalData: TollSummary | null;
  setTollModalData: (data: TollSummary | null) => void;
  ...
  handleTollModalOpen: (tollSummary: TollSummary) => void;
}
...
export const AppStateProvider = ({
  ...
  const [tollModalData, setTollModalData] = useState<TollSummary | null>(null);
  ...
  const handleTollModalOpen = (tollSummary: TollSummary) => {
