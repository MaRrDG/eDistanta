...
import { TollService } from '@services/api/tollService';
import type { VehicleType as TollVehicleType } from '@core/entities/vehicle';
...
interface RouteDetailsProps {
  ...
  startName?: string;
  endName?: string;
  onTollModalOpen?: (tollSummary: TollSummary) => void;
}
...
const RouteDetails = ({
  ...
  const tollSummary: TollSummary = useMemo(() => {
