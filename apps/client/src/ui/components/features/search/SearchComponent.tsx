...
import type { SearchComponentProps, LocationResult } from '@core/entities/location';
import type { FavoriteRoute } from '@core/entities/favorite';
import { useLocationSearch } from '@ui/hooks/useLocationSearch';
import { useWaypoints } from '@ui/hooks/useWaypoints';
import { RouteService } from '@services/api/routeService';
import { useRouteDetails } from '@contexts/RouteDetailsContext';
import { isLocationInRomania } from '@core/entities/location';
import LocationInput from './LocationInput';
import WaypointInput from './WaypointInput';
import { FavoritesSection } from '../favorites';
import { useSaveRouteSearch } from '@ui/hooks/useRouteHistory';
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 pb-12 md:pb-4">
        ...
        <BaseButton
          ...
          variant={hasRouteChanges && hasCalculatedRoute ? 'warning' : 'primary'}
          size="lg"
          className="w-full shadow-lg"
          leftIcon={
            hasRouteChanges && hasCalculatedRoute && !isCalculating && (
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
