...
import type { TollBridge, TollSummary } from '../../core/entities/toll';
import type { VehicleType } from '../../core/entities/vehicle';
...
export class TollService {
  ...
  static calculateTotalTollCost(
    ...
    return bridges.reduce((total, bridge) => {
      ...
      if (bridge.vehicleRates) {
        const vehicleRate = bridge.vehicleRates[vehicleType as keyof typeof bridge.vehicleRates];
   ...
   */
  static getTollSummary(bridges: TollBridge[], vehicleType: VehicleType = 'car'): TollSummary {
