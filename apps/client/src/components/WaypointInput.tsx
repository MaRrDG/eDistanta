  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        ...
        {/* No results message */}
        {showSuggestions && suggestions.length === 0 && waypoint.name.trim() && !isLoading && (
        ...
        {waypoint.name.trim() && !isLoading && suggestions.length > 0 && showSuggestions && (
          <div className="absolute z-5 w-full bg-blue-50 border border-blue-200 rounded-md shadow-lg p-2 text-xs text-blue-700" style={{ top: `calc(100% + 1rem + ${Math.min(suggestions.length * 60, 240)}px)` }}>
